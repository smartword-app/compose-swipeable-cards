...
object SwipeableCardsDefaults {
    ...
    const val DRAGGING_ACCELERATION = 1.3f
 ...
 *
 * @property visibleCardsInStack Number of cards visible in the stack simultaneously. Defaults to [SwipeableCardsDefaults.VISIBLE_CARDS_IN_STACK].
...
data class SwipeableCardsProperties(
    ...
    val padding: Dp = SwipeableCardsDefaults.PADDING * visibleCardsInStack,
